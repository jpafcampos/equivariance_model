...
def main():
    ...
    if args.model.upper()=='FCN':
        ...
        model = trans_fcn.TransFCN8s(pretrained_net=res50model, num_class=num_classes, dim=768, depth=6, heads=12, batch_size = args.batch_size, trans_img_size=size_crop/16)
